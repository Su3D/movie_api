...
const mapStateToProps = state => {
  ...
  if (visibilityFilter !== '' && sortColumn === 'Genre') {
    moviesToShow = moviesToShow.filter(movie => movie.Genre.Type.toLowerCase().includes(visibilityFilter.toLowerCase()));
  }

  if (visibilityFilter !== '' && sortColumn === 'Rating') {
    moviesToShow = moviesToShow.filter(movie => movie.Rating.Type.toLowerCase().includes(visibilityFilter.toLowerCase()));
  }
